...
export default function About() {
  ...
  return (
    <div className="bg-background text-deep-indigo font-body">
      ...
      <main>
        {/* SECTION 1: HERO */}
        <section className="relative px-6 md:px-12 pt-32 pb-32 overflow-hidden bg-white border-b border-soft-teal/10">
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="z-10">
              <span className="text-calm-blue font-bold tracking-widest text-xs uppercase mb-6 block">
                Our Heart & Philosophy
              </span>
              <h1 className="font-headline font-bold text-5xl md:text-7xl leading-[1.1] mb-8 text-deep-indigo">
        ...
        <section className="bg-background py-32 px-6 md:px-12">
          <div className="max-w-7xl mx-auto">
            <div className="text-center max-w-3xl mx-auto mb-20">
              ...
              <p className="text-deep-indigo/80 text-lg font-light">
                We believe exceptional care requires more than clinical skill—it demands hospitality.
              </p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
              <div className="bg-white p-10 rounded-2xl shadow-sm border border-soft-teal/10 hover:shadow-md transition-shadow">
                <span className="material-symbols-outlined text-soft-teal text-4xl mb-6">restaurant</span>
                <h3 className="font-headline font-bold text-2xl text-deep-indigo mb-4">Nourishing Body & Soul</h3>
                <p className="text-deep-indigo/70 font-light leading-relaxed">
              ...
              <div className="bg-white p-10 rounded-2xl shadow-sm border border-soft-teal/10 hover:shadow-md transition-shadow">
                <span className="material-symbols-outlined text-calm-blue text-4xl mb-6">bedtime</span>
                <h3 className="font-headline font-bold text-2xl text-deep-indigo mb-4">The Art of Stillness</h3>
                <p className="text-deep-indigo/70 font-light leading-relaxed">
              ...
              <div className="bg-white p-10 rounded-2xl shadow-sm border border-soft-teal/10 hover:shadow-md transition-shadow">
                <span className="material-symbols-outlined text-deep-indigo text-4xl mb-6">spa</span>
                <h3 className="font-headline font-bold text-2xl text-deep-indigo mb-4">Dignified Wellness</h3>
                <p className="text-deep-indigo/70 font-light leading-relaxed">
        ...
        <section className="py-32 px-6 md:px-12 bg-white">
          <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-20 items-start">
            <div className="lg:w-1/2 sticky top-32">
              <h2 className="font-headline font-bold text-4xl md:text-5xl text-deep-indigo mb-8">
            ...
            <div className="lg:w-1/2 space-y-12">
              ...
              <div className="bg-[#FCF9F4] p-12 rounded-2xl border border-warm-yellow/30">
                <h4 className="font-headline font-bold text-2xl text-deep-indigo mb-6">
