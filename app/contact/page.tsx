      ...
      <main className="pt-24 pb-32">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-32">
            <div className="pt-12">
              <h1 className="text-5xl md:text-7xl font-headline font-bold text-deep-indigo mb-8 leading-tight">
                Let's start with a <span className="italic font-light text-soft-teal">conversation.</span>
              </h1>
              <p className="text-xl md:text-2xl font-light text-deep-indigo/80 leading-relaxed max-w-lg mb-12">
              ...
              <div className="space-y-10">
                <div className="flex items-start gap-6">
                  <div className="w-14 h-14 rounded-full bg-calm-blue/10 flex items-center justify-center text-calm-blue shrink-0">
                    <span className="material-symbols-outlined text-2xl">call</span>
                  </div>
                  <div>
                    <p className="text-sm font-bold uppercase tracking-widest text-deep-indigo/60 mb-1">Phone</p>
                    <p className="text-2xl font-headline font-bold text-deep-indigo">1-800-NURTURE</p>
                  </div>
                </div>
                
                <div className="flex items-start gap-6">
                  <div className="w-14 h-14 rounded-full bg-soft-teal/10 flex items-center justify-center text-soft-teal shrink-0">
                ...
                <div className="flex items-start gap-6">
                  <div className="w-14 h-14 rounded-full bg-sage/10 flex items-center justify-center text-sage shrink-0">
                    <span className="material-symbols-outlined text-2xl">event_available</span>
                  </div>
                  <div>
                    <p className="text-sm font-bold uppercase tracking-widest text-deep-indigo/60 mb-1">In-Home Visit</p>
                    <p className="text-2xl font-headline font-bold text-deep-indigo">Care Consultation</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="relative">
              ...
              {/* Decorative Element */}
              <div className="absolute -bottom-8 -left-8 w-64 h-80 bg-warm-yellow/20 rounded-2xl -z-0"></div>
            </div>
          </div>

          {/* Form Section */}
          <section className="bg-white rounded-3xl p-10 md:p-20 shadow-lg border border-soft-teal/10 relative overflow-hidden">
            <div className="mb-12 relative z-10">
              <h2 className="text-4xl font-headline font-bold text-deep-indigo mb-4">Send us a Message</h2>
              <p className="text-deep-indigo/70 text-lg font-light max-w-2xl">
            ...
            <div className="absolute top-0 right-0 w-96 h-96 bg-background rounded-bl-full pointer-events-none -z-0 opacity-50"></div>
          </section>
          ...
          <section className="mt-32 grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            ...
            <div className="order-1 md:order-2 space-y-6">
              <h3 className="text-4xl md:text-5xl font-headline text-deep-indigo font-bold leading-tight">
