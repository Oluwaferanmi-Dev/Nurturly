...
export const metadata: Metadata = {
  title: 'For Families | Nurturly',
  description: 'Support and resources for families exploring home care options.',
}
        ...
        <section className="bg-surface-container-lowest py-16 md:py-24">
          <div className="max-w-4xl mx-auto px-6 lg:px-12">
            <p className="text-lg text-on-surface leading-relaxed mb-8">
              Coming soon. We&apos;re preparing resources and information to support families.
            </p>
