  ...
  return (
    <div className="bg-background text-deep-indigo font-body min-h-screen">
      ...
      <main>
          ...
          <div className="max-w-7xl mx-auto px-6 md:px-12">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
              ...
              <div className="lg:col-span-6 lg:offset-1 order-1 lg:order-2 space-y-6">
                <span className="text-sage font-bold tracking-widest uppercase text-xs mb-2 block">
                  01 — The Standard
                </span>
                <h2 className="font-headline text-4xl md:text-5xl text-deep-indigo font-bold">
                  Dignity in Every Moment
                </h2>
                <p className="text-lg leading-relaxed font-light text-deep-indigo/80">
        ...
        <section className="bg-white border-y border-soft-teal/10 py-32 mb-32 md:mb-40">
          <div className="max-w-7xl mx-auto px-6 md:px-12">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 lg:gap-24">
              ...
              <div className="flex flex-col space-y-6">
                ...
                <p className="text-lg leading-relaxed font-light text-deep-indigo/80 mb-6">
        ...
        <section className="mb-32 md:mb-40 relative">
          <div className="max-w-7xl mx-auto px-6 md:px-12 lg:flex items-center gap-16">
            <div className="lg:w-7/12 relative z-10 w-full">
              <div className="bg-white p-12 md:p-16 lg:p-20 shadow-xl rounded-3xl border border-soft-teal/10">
                <span className="text-sage font-bold tracking-widest uppercase text-xs mb-4 block">
                  04 — The Feeling
                </span>
                <h2 className="font-headline text-4xl md:text-5xl text-deep-indigo mb-8 font-bold">
                  The Warmth of Hospitality
                </h2>
                <p className="text-2xl leading-relaxed text-calm-blue italic font-headline mb-8">
        ...
        <section className="mb-32 md:mb-40 py-32 bg-background">
          <div className="max-w-7xl mx-auto px-6 md:px-12">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
              <div className="lg:col-span-6 space-y-6">
                ...
                <div className="flex gap-6">
                  <span className="material-symbols-outlined text-calm-blue text-4xl">devices</span>
                  <span className="material-symbols-outlined text-soft-teal text-4xl">health_metrics</span>
                  <span className="material-symbols-outlined text-sage text-4xl">shield_with_heart</span>
                </div>
              </div>
        ...
        <section className="max-w-5xl mx-auto px-6 md:px-12 mb-32">
          <div className="bg-white rounded-3xl p-12 md:p-20 text-center shadow-xl border border-warm-yellow/30 relative overflow-hidden">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-6 relative z-10">
              ...
              <Link
                href="/contact"
                className="border border-soft-teal/20 bg-background text-deep-indigo px-10 py-5 rounded-xl font-bold text-lg hover:bg-white transition-all text-center"
              >
                Get in Touch
              </Link>
            </div>
