...
export async function sendCandidateEmail({
  ...
  const { error } = await resend.emails.send({
    from: `CareBase Care Team <hello@yourcaredomain.com>`,
    to: [toEmail],
    subject,
    html: `
      <div style="font-family: 'Manrope', sans-serif; max-width: 600px; margin: 0 auto; background: #fcf9f4;">
        <div style="background: linear-gradient(135deg, #00535b 0%, #006d77 100%); padding: 32px; text-align: center;">
          <h2 style="color: white; font-family: Georgia, serif; margin: 0; font-size: 28px; font-weight: 400; letter-spacing: -0.5px;">CareBase</h2>
        ...
        <div style="background: #f6f3ee; padding: 20px 32px; text-align: center; border-top: 1px solid #e5e2dd;">
          <p style="color: #5f5e5b; font-size: 11px; margin: 0;">CareBase Home Care &middot; [YOUR_CITY], [YOUR_STATE] &middot; <a href="mailto:hello@yourcaredomain.com" style="color: #00535b;">hello@yourcaredomain.com</a></p>
        </div>
      </div>
    `,
  })
